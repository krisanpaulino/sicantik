	...
	<section class="content">
		<div class="container-fluid">
			<div class="row">
				<!-- left column -->
				<div class="col-md-12">
					<a href="<?= base_url() ?>operator/daftar_pasien_tb" class="btn btn-primary mb-4">Daftar Pasien TB</a>
									...
									<?php if (!empty($data_sesi)) { ?>
										<?php foreach ($data_sesi as $data) : ?>
											<tr>
												...
												<td><?= $data['tahun'] ?></td>
												<td>
													<a href="<?= base_url() ?>operator/laporan_tbprogram/<?= $data['id'] ?>/" class="badge badge-primary">Lihat</a>
												</td>
											</tr>
										<?php endforeach; ?>
									<?php } ?>
					...
					<div class="modal fade" id="inputModal" tabindex="-1" role="dialog" aria-labelledby="inputModalLabel" aria-hidden="true">
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<form action="<?= base_url() ?>operator/to_inputdata_apotik" method="post">
