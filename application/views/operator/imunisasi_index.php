					...
					<div class="card card-white">
						<div class="card-body">
							<table class="table table-bordered">
								...
								<tbody>
									<?php if (!empty($data_imunisasi)) { ?>
										<?php foreach ($data_imunisasi as $data) : ?>
											<tr>
												<td><?= $data['nama_bulan'] ?></td>
												<td><?= $data['tahun'] ?></td>
												<td>
													<a href="<?= base_url() ?>operator/laporan_data_imunisasi/<?= $data['id'] ?>/" class="badge badge-primary">Lihat</a>
												</td>
											</tr>
										<?php endforeach; ?>
									<?php } ?>
					...
					<div class="modal fade" id="inputModal" tabindex="-1" role="dialog" aria-labelledby="inputModalLabel" aria-hidden="true">
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<form action="<?= base_url() ?>operator/to_inputdata_imunisasi/" method="post">
