		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-lg-12 d-flex justify-content-end mb-4">
					<a href="<?= base_url() ?>adm/data/laporan_pkp_gabungan/<?= $sesi['id'] ?>" class="btn btn-primary">Lihat Seluruh Puskesmas</a>
				</div>
				<div class="col-md-12">
								...
								<tbody>
									<?php foreach ($data_puskesmas as $puskesmas) : ?>
										<tr>
											...
											<td>
												<a href="<?= base_url() ?>adm/data/laporan_pkp/<?= $sesi['id'] ?>/<?= $puskesmas['id'] ?>" class="badge badge-info">Lihat</a>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
